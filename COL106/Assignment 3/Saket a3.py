...
class PointDatabase:
    ...
    def BSTMaker1d(self, pointlist):
        ...
        node.left, node.right = self.BSTMaker1d(
            pointlist[:mid]), self.BSTMaker1d(pointlist[mid:])
        return node
    ...
    def BSTMaker2d(self, root):
        ...
        root.ylist = self.MergeList(self.MergeList(
            root.left.ylist, root.right.ylist), [root.value, ])
        return

    # Insert element on top, then balance
    # Sort wrt y
    # Redo yourself
    ...
    def minTraversal(self, root):
        if (root.value[0] > self.x_min):
            ...
            if (root.right != None):
                self.nearbylist = self.nearbylist + \
                    self.Find1d(root.right.ylist)
            if (root.left != None):
...
#PD = PointDatabase([(1,6), (2,4), (3,7), (4,9), (5,1), (6,3), (7,8), (8,10), (9,2), (10,5)])
# PD.Find1d([(2,1),(2,3),(2,5),(2,7),(2,9)],2,4) #0 2 4 6 8 10 ke all perms,
#print(PD.searchNearby((5,5), 3.5)) - Passed
#print(PD.searchNearby((4,8), 2))
#print(PD.searchNearby((5,5), 1))
#print(PD.searchNearby((10,2), 1.5))
#print(PD.searchNearby((1,5), 3))
#print(PD.searchNearby((1,5), 2))
#print(PD.searchNearby((8,6), 3))
# print(1)
